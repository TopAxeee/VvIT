object Typeclasses {
  ...
  def main(args: Array[String]): Unit = {
    println("--Reverse--")
    println("Reverse:" + testReversableString("Reverse"))
    println("--Smash--")
    println("Int (20 + 10): " + testSmashInt(20, 10))
    println("Double (1.5 * 3.0): " + testSmashDouble(1.5, 3.0))
    println("String (\"Type\"+\"classes\"): " + testSmashString("Type", "classes"))
  }
}
